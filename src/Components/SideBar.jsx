    ...
    <div className="container-fluid">
      ...
      <section className="collapse navbar-collapse" id="navcollapse">
        <ul className="navbar-nav d-flex gap-5 mx-auto m-2 align-items-center">
          ...
          <Link to="/" className="text-decoration-none nav-link" data-bs-toggle="collapse" data-bs-target="#navcollapse">
            <li className="nav-item">Home</li>
          </Link>
  
          <Link to="/RecentlyViewed" className="text-decoration-none nav-link" data-bs-toggle="collapse" data-bs-target="#navcollapse">
            <li className="nav-item">Recently Viewed</li>
          </Link>
  
          <Link to="/MovieLiked" className="text-decoration-none nav-link" data-bs-toggle="collapse" data-bs-target="#navcollapse">
            <li className="nav-item">Liked Movies</li>
          </Link>
  
          <select className="form-select form-select-sm rounded p-2 text-center"
