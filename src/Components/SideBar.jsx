      ...
      <div className="container-fluid">
        ...
        <section className="collapse navbar-collapse" id="navcollapse">
          <ul className="navbar-nav d-flex gap-5 mx-auto m-2 align-items-center">
            <input type="text" className="form-control inputfield ms-3" placeholder="Search" onChange={handleSearchInput} />
            <Link to="/" className="text-decoration-none" >
              <li className="nav-item" data-bs-toggle="collapse" data-bs-target="#navcollapse">Home</li>
            </Link>
            <Link className="text-decoration-none" to="/RecentlyViewed" >
              <li className="nav-item" data-bs-toggle="collapse" data-bs-target="#navcollapse">Recently viewed</li>
            </Link>
            <Link className="text-decoration-none" to="/MovieLiked" data-bs-toggle="collapse" data-bs-target="#navcollapse">
              <li className="nav-item" data-bs-toggle="collapse" data-bs-target="#navcollapse">Liked Movies</li>
            </Link>
